...
class SettingsDialog extends StatefulWidget {
  const SettingsDialog({super.key, this.initialTab = SettingsTab.intelligence});
  final SettingsTab initialTab;

  static Future<void> show(BuildContext context,
      {SettingsTab initial = SettingsTab.intelligence}) async {
...
class _SettingsDialogState extends State<SettingsDialog> {
  ...
  Widget _content(SettingsTab t) {
    switch (t) {
      case SettingsTab.intelligence:
        // Reached through the single-instance holder rather than passed down
        // through the dialog: settings is opened from several places and none
        // of them should have to know about the gateway.
        return IntelligenceTab(client: DexGatewayClient.current!);
      case SettingsTab.preferences:
        return const PreferencesTab();
      case SettingsTab.memory:
        return const MemoryTab();
      case SettingsTab.account:
        return AccountTab(onNavigate: _navigate);
      case SettingsTab.connectors:
        return ConnectorsTab(onNavigate: _navigate);
