...
void main() {
  testWidgets('Dex boots and shows the empty state', (tester) async {
    // Use a realistic desktop viewport -- the layout assumes >= 1280 wide.
    ...
    expect(find.text('A calm cockpit for commanding agents.'), findsOneWidget);
