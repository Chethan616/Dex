...
{
  agents: {
    list: [{ id: "support", name: "Support", workspace: "~/.dex/workspace-support" }],
  },
  bindings: [
...
Session stores live under the state directory (default `~/.dex`):

- `~/.dex/agents/<agentId>/sessions/sessions.json`
