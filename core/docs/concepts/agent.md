...
Recommended: use `openclaw setup` to create `~/.dex/openclaw.json` if missing and initialize the workspace files.
...
- `~/.dex/agents/<agentId>/sessions/<SessionId>.jsonl`
