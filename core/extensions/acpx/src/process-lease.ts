...
export const DEX_ACPX_LEASE_ID_ENV = "DEX_ACPX_LEASE_ID";
export const DEX_GATEWAY_INSTANCE_ID_ENV = "DEX_GATEWAY_INSTANCE_ID";
export const DEX_ACPX_LEASE_ID_ARG = "--openclaw-acpx-lease-id";
export const DEX_GATEWAY_INSTANCE_ID_ARG = "--openclaw-gateway-instance-id";
...
export function withAcpxLeaseEnvironment(params: {
  ...
  return [
    "env",
    `${DEX_ACPX_LEASE_ID_ENV}=${quoteEnvValue(params.leaseId)}`,
    `${DEX_GATEWAY_INSTANCE_ID_ENV}=${quoteEnvValue(params.gatewayInstanceId)}`,
