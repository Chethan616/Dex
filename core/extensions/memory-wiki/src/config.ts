...
import { buildPluginConfigSchema, z, type DexPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: DexPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".dex", "wiki", "main");
}
