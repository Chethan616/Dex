...
function getNostrConfig(cfg: DexConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: DexConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: DexConfig): string {
