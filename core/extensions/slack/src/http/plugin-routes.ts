...
import type { DexPluginApi } from "openclaw/plugin-sdk/channel-plugin-common";
...
function resolveSlackWebhookPaths(config: DexPluginApi["config"]): string[] {
...
export function registerSlackPluginHttpRoutes(api: DexPluginApi): void {
