...
function resolveDefaultAgentId(cfg: DexConfig): string {
...
function listBoundAccountIds(cfg: DexConfig, channelId: string): string[] {
  const ids = new Set<string>();
...
function resolveDefaultAgentBoundAccountId(cfg: DexConfig, channelId: string): string | null {
...
function hasImplicitDefaultTelegramAccount(cfg: DexConfig): boolean {
...
export function listTelegramAccountIds(cfg: DexConfig): string[] {
...
export function resolveDefaultTelegramAccountSelection(cfg: DexConfig): {
  accountId: string;
  accountIds: string[];
...
export function resolveDefaultTelegramAccountId(cfg: DexConfig): string {
