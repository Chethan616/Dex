...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): DexConfig => telegramDeps.getRuntimeConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: DexConfig): TelegramAccountConfig => {
    try {
