...
export function listWhatsAppAuthDirs(cfg: DexConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: DexConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: DexConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: DexConfig): ResolvedWhatsAppAccount[] {
