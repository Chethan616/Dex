import type { AcpRuntime, AcpRuntimeCapabilities } from "@dexagent/acp-core/runtime/types";
...
export type { AcpRuntime, DexConfig, SessionAcpMeta };
...
export const ORIGINAL_STATE_DIR = process.env.DEX_STATE_DIR;
