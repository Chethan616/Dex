...
type ConfiguredBinding = NonNullable<DexConfig["bindings"]>[number];
...
function resolveBindingRecord(cfg: DexConfig, overrides: Partial<BindingRecordInput> = {}) {
