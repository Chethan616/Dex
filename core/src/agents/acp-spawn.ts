...
} from "@dexagent/acp-core/runtime/session-identifiers";
...
function resolveHeartbeatConfigForAgent(params: {
  cfg: DexConfig;
  agentId: string;
}): NonNullable<NonNullable<DexConfig["agents"]>["defaults"]>["heartbeat"] {
...
function isExplicitlyAllowedAcpAgent(cfg: DexConfig, agentId: string): boolean {
...
function resolveConfiguredAcpSubagentTargetIds(cfg: DexConfig): string[] {
