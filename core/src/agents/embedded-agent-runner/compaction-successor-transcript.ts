...
import { resolveTimestampMsToIsoString } from "@dexagent/normalization-core/number-coercion";
...
export function shouldRotateCompactionTranscript(config?: DexConfig): boolean {
