...
import { DEX_AGENT_RUNTIME_ID, isDefaultAgentRuntimeId } from "./agent-runtime-id.js";
...
function isSelectablePluginRuntime(runtime: string | undefined): runtime is string {
  return (
    ...
    normalizeOptionalAgentRuntimeId(runtime) !== DEX_AGENT_RUNTIME_ID
  );
}
...
function pushConfiguredModelRuntimeIds(config: DexConfig, runtimes: Set<string>): void {
