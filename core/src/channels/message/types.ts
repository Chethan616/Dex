...
export type ChannelMessageSendTextContext<TConfig = DexConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = DexConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = DexConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = DexConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = DexConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = DexConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = DexConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
