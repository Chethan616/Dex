...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: DexConfig, deps?: BrowserDoctorDeps) => Promise<void>;
...
export async function noteChromeMcpBrowserReadiness(cfg: DexConfig, deps?: BrowserDoctorDeps) {
  try {
