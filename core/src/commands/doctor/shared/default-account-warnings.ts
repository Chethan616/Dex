...
export function collectMissingDefaultAccountBindingWarnings(cfg: DexConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: DexConfig): string[] {
  const warnings: string[] = [];
