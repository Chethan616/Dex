...
function collectToolAllowlistSources(cfg: DexConfig): ToolAllowlistSource[] {
...
function collectConfiguredMcpServerNames(cfg: DexConfig): string[] {
...
function collectSandboxMcpAllowlistWarnings(cfg: DexConfig): string[] {
