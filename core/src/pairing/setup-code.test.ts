...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("DEX_GATEWAY_TOKEN", "");
    vi.stubEnv("DEX_GATEWAY_PASSWORD", "");
    vi.stubEnv("DEX_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses DEX_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
