...
export const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    diagnostics: ["DEX_PLUGIN_SDK_COMPAT_DEPRECATED"],
    tests: [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "DEX_FORCE_PLUGIN_REGISTRY_MIGRATION",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`DexConfig` from `openclaw/plugin-sdk/config-schema`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["openclaw/plugin-sdk `DexSchemaType` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    ...
    diagnostics: ["DEX_EXTENSION_API_DEPRECATED"],
