...
import { normalizeArrayBackedTrimmedStringList } from "@dexagent/normalization-core/string-normalization";
...
export function hasExplicitPluginConfig(plugins?: DexConfig["plugins"]): boolean {
  if (!plugins) {
    return false;
  }
