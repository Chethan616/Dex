@echo off
rem dex-fill Windows launcher. The tool itself is a POSIX shell script (curl,
...
set "SCRIPT_DIR=%~dp0"
set "BASH_SCRIPT=%SCRIPT_DIR%dex-fill"
...
>&2 echo dex-fill: bash.exe not found. Install Git for Windows from https://gitforwindows.org/ or set DEX_BASH to a bash.exe path.
exit /b 1
