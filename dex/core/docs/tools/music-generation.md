...
```bash
DEX_LIVE_TEST=1 pnpm test:live -- extensions/music-generation-providers.live.test.ts
```
...
```bash
DEX_LIVE_TEST=1 COMFY_LIVE_TEST=1 pnpm test:live -- extensions/comfy/comfy.live.test.ts
```
