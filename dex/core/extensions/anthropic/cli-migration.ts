...
type AgentDefaultsModel = NonNullable<NonNullable<DexConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<DexConfig["agents"]>["defaults"]>["models"];
