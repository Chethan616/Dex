...
import type { DiscordAccountConfig, DiscordActionConfig, DexConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: DexConfig): ResolvedDiscordAccount[] {
