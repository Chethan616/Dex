...
type PreflightResult =
  ...
  | {
      ok: false;
      result: DexPluginNodeInvokePolicyResult;
    };
...
async function handleFileTransferInvoke(
  ctx: DexPluginNodeInvokePolicyContext,
): Promise<DexPluginNodeInvokePolicyResult> {
...
export function createFileTransferNodeInvokePolicy(): DexPluginNodeInvokePolicy {
  return {
