...
function getToolConfig(options: MemoryToolOptions): DexConfig | undefined {
...
function resolveMemoryToolOptions(ctx: DexPluginToolContext): MemoryToolOptions {
