import type { DexConfig } from "openclaw/plugin-sdk/memory-core-host-runtime-core";
...
function isGlobalSessionKeyForSharedScope(cfg: DexConfig, key: string): boolean {
