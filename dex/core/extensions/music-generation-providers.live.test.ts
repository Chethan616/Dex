...
const providerFilter = parseCsvFilter(process.env.DEX_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.DEX_LIVE_MUSIC_GENERATION_MODELS);
