...
function resolveConfiguredDefaultNostrAccountId(cfg: DexConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: DexConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: DexConfig): string {
