...
import { buildPluginConfigSchema, type DexPluginConfigSchema } from "openclaw/plugin-sdk/core";
import {
...
export function createOpenShellPluginConfigSchema(): DexPluginConfigSchema {
