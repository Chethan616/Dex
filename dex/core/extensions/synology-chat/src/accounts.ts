...
function getChannelConfig(cfg: DexConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: DexConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.DEX_BOT_NAME ?? "OpenClaw";
