...
function mergeZaloAccountConfig(cfg: DexConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: DexConfig): ResolvedZaloAccount[] {
