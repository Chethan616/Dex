...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: DexConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: DexConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: DexConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(cfg: DexConfig): Promise<void> {
