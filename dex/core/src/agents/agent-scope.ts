...
function findMutableAgentEntry(cfg: DexConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: DexConfig, agentId: string): string | undefined {
