...
export function resolveSubagentToolPolicy(cfg?: DexConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: DexConfig["tools"]): string[] | undefined {
