...
function resolveExecConfig(params: { cfg?: DexConfig; agentId?: string }) {
...
export type DexCodingToolConstructionPlan = {
...
export function createDexCodingTools(options?: {
  agentId?: string;
  ...
  toolConstructionPlan?: DexCodingToolConstructionPlan;
