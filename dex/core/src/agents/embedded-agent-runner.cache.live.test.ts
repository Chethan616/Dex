...
describeCacheLive("embedded agent runner prompt caching (live)", () => {
  beforeAll(async () => {
    ...
    previousCacheTraceEnv = {
      enabled: process.env.DEX_CACHE_TRACE,
      file: process.env.DEX_CACHE_TRACE_FILE,
      messages: process.env.DEX_CACHE_TRACE_MESSAGES,
      prompt: process.env.DEX_CACHE_TRACE_PROMPT,
      system: process.env.DEX_CACHE_TRACE_SYSTEM,
    };
    process.env.DEX_CACHE_TRACE = "1";
    process.env.DEX_CACHE_TRACE_FILE = liveCacheTraceFile;
    process.env.DEX_CACHE_TRACE_MESSAGES = "0";
    process.env.DEX_CACHE_TRACE_PROMPT = "0";
    process.env.DEX_CACHE_TRACE_SYSTEM = "0";
  }, 120_000);
  ...
  afterAll(async () => {
    if (previousCacheTraceEnv) {
      ...
      restore("DEX_CACHE_TRACE", previousCacheTraceEnv.enabled);
      restore("DEX_CACHE_TRACE_FILE", previousCacheTraceEnv.file);
      restore("DEX_CACHE_TRACE_MESSAGES", previousCacheTraceEnv.messages);
      restore("DEX_CACHE_TRACE_PROMPT", previousCacheTraceEnv.prompt);
      restore("DEX_CACHE_TRACE_SYSTEM", previousCacheTraceEnv.system);
    }
  ...
  describe("openai", () => {
    ...
    beforeAll(async () => {
      fixture = await resolveLiveDirectModel({
        ...
        envVar: "DEX_LIVE_OPENAI_CACHE_MODEL",
  ...
  describe("anthropic", () => {
    ...
    beforeAll(async () => {
      fixture = await resolveLiveDirectModel({
        ...
        envVar: "DEX_LIVE_ANTHROPIC_CACHE_MODEL",
