...
import { isDefaultAgentRuntimeId, DEX_AGENT_RUNTIME_ID } from "../agent-runtime-id.js";
...
function restrictiveAllowlistOmitsPlugin(config: DexConfig | undefined, pluginId: string) {
