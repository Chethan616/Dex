...
const TEST_ENV_VAR = "DEX_MODELS_CONFIG_TEST_ENV";
...
function createConfigEnvVarsConfig(): DexConfig {
  return {
    models: { providers: {} },
    env: {
      vars: {
...
async function resolveProvidersAndCaptureDiscoveryEnv(cfg: DexConfig) {
