...
const VIRTUAL_MODULES: Record<string, unknown> = {
  ...
  "@dexagent/plugin-sdk/agent-core": bundledAgentCore,
  "openclaw/plugin-sdk/llm": bundledLlm,
  "@dexagent/plugin-sdk/llm": bundledLlm,
  "openclaw/plugin-sdk/agent-sessions": bundledAgentSessions,
  "@dexagent/plugin-sdk/agent-sessions": bundledAgentSessions,
};
...
function getExtensionLoaderAliases(): Record<string, string> {
  ...
  aliases = {
    ...
    "@dexagent/plugin-sdk/agent-sessions": agentSessionsEntry,
