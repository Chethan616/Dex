...
import { isRecord as isPlainObject } from "@dexagent/normalization-core/record-coerce";
import {
...
function assertGatewayConfigMutationAllowed(params: {
  ...
  const nextFlags = collectEnabledInsecureOrDangerousFlags(nextConfig as DexConfig);
