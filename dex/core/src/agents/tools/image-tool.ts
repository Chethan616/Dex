...
function hasExplicitDefaultPrimaryModel(cfg?: DexConfig): boolean {
...
function pickMaxBytes(cfg?: DexConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const providerCfg: DexConfig = effectiveCfg ?? {};
