...
import type { DexPackageManifest } from "../../plugins/manifest.js";
...
const ENV_CATALOG_PATHS = ["DEX_PLUGIN_CATALOG_PATHS", "DEX_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<DexPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
