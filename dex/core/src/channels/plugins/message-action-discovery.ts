...
export function listChannelMessageActions(cfg: DexConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: DexConfig): ChannelMessageCapability[] {
