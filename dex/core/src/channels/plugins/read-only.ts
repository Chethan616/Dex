...
function getChannelConfigRecord(cfg: DexConfig, channelId: string): Record<string, unknown> {
...
function listManifestChannelAccountIds(cfg: DexConfig, channelId: string): string[] {
