...
const DEFAULT_CLI_NAME = "dex";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "openclaw", "dex-core"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(openclaw|dex-core|dex)\b/;
