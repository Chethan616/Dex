    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["dex directory self --channel slack", "Show the connected account identity."],
          [
            'dex directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["dex directory groups list --channel discord", "List available groups/channels."],
          [
            "dex directory groups members --channel discord --group-id <id>",
