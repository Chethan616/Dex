      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["dex gateway run", "Run the gateway in the foreground."],
            ["dex gateway status", "Show service status plus connectivity/capability."],
            ["dex gateway discover", "Find local and wide-area gateway beacons."],
            ["dex gateway stability", "Show recent stability diagnostics."],
            ["dex gateway call health", "Call a gateway RPC method directly."],
