...
type StatusJsonScanPolicy = {
  ...
  gatewayProbeTimeoutMs?: number | ((cfg: DexConfig) => number | undefined);
...
function hasExplicitStatusJsonChannelConfig(cfg: DexConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: DexConfig): boolean {
