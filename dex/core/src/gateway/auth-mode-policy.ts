...
export function hasAmbiguousGatewayAuthModeConfig(cfg: DexConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: DexConfig): void {
