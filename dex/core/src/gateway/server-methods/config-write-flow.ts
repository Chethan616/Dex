...
export function didSharedGatewayAuthChange(prev: DexConfig, next: DexConfig): boolean {
...
}): Promise<{ path: string; config: DexConfig; queueFollowUp: () => void }> {
