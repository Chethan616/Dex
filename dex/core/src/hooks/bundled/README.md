...
**Output**: `<workspace>/memory/YYYY-MM-DD-slug.md` (defaults to `~/.dex/workspace`)
...
- **Managed hooks**: `~/.dex/hooks/` (shared across workspaces)
...
Hooks can be configured in `~/.dex/openclaw.json`:
