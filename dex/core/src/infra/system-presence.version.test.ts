...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when DEX_VERSION is not set", async () => {
  ...
  it("prefers DEX_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over DEX_SERVICE_VERSION when DEX_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        DEX_VERSION: " ",
        DEX_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when DEX_VERSION and DEX_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        DEX_VERSION: " ",
        DEX_SERVICE_VERSION: "\t",
