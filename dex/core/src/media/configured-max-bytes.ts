...
export function resolveConfiguredMediaMaxBytes(cfg?: DexConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: DexConfig | undefined, kind: MediaKind) {
