...
type ChannelConfigAccessorParams<Config extends DexConfig = DexConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends DexConfig = DexConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends DexConfig = DexConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: DexConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends DexConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends DexConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends DexConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
