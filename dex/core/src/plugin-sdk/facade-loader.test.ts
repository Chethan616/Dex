...
describe("plugin-sdk facade loader", () => {
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    ...
    process.env.DEX_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.DEX_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    ...
    process.env.DEX_BUNDLED_PLUGINS_DIR = createTempDirSync("openclaw-facade-loader-empty-");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    ...
    process.env.DEX_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
