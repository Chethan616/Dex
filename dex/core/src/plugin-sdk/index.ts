...
/** @deprecated Use DexConfig instead */
export type { DexConfig as ClawdbotConfig } from "../config/config.js";
/** @deprecated Use DexConfig instead */
export type { DexConfig as DexSchemaType } from "../config/config.js";
export type {
