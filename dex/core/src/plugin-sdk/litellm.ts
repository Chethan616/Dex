...
import type { ModelDefinitionConfig, DexConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: DexConfig) => DexConfig;
  applyLitellmProviderConfig: (cfg: DexConfig) => DexConfig;
