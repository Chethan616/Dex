...
function normalizePluginsConfigForInstalledIndex(
  config: DexConfig["plugins"] | undefined,
...
function listPotentialEnabledChannelIds(config: DexConfig, env: NodeJS.ProcessEnv): string[] {
...
function resolveGatewayStartupDreamingPluginIds(config: DexConfig): Set<string> {
...
function collectConfiguredWebSearchProviderIds(config: DexConfig): ReadonlySet<string> {
...
function collectConfiguredVoiceProviderIds(config: DexConfig): ConfiguredVoiceProviderIds {
...
function collectValidationHeartbeatTargetChannelIds(config: DexConfig): string[] {
...
function collectValidationChannelConfigIds(config: DexConfig): string[] {
...
function collectConfiguredProviderIds(config: DexConfig): string[] {
...
function collectValidationConfiguredProviderIds(config: DexConfig): string[] {
...
function collectValidationConfiguredShorthandModelIds(config: DexConfig): string[] {
  return sortUniquePluginIds(
