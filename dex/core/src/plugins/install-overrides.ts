...
export const PLUGIN_INSTALL_OVERRIDES_ENV = "DEX_PLUGIN_INSTALL_OVERRIDES";
export const ALLOW_PLUGIN_INSTALL_OVERRIDES_ENV = "DEX_ALLOW_PLUGIN_INSTALL_OVERRIDES";
