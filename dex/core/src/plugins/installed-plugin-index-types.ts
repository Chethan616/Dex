...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by OpenClaw from plugin manifests, install records, and config policy. Use `dex plugins registry --refresh`, `dex plugins install/update/uninstall`, or `dex plugins enable/disable` instead.";
