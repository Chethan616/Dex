...
import type { DexPluginToolContext } from "./types.js";
...
function resolvePluginToolFactory(entry: PluginToolRegistration, ctx: DexPluginToolContext) {
