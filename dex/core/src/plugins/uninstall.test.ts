...
type PluginConfig = NonNullable<DexConfig["plugins"]>;
...
function createSinglePluginWithEmptySlotsConfig(): DexConfig {
...
function createSingleNpmInstallConfig(installPath: string): DexConfig {
  return createPluginConfig({
    entries: createSinglePluginEntries(),
    installs: {
