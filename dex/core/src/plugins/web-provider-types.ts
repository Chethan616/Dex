...
export type WebSearchProviderPlugin = {
  ...
  setConfiguredCredentialValue?: (configTarget: DexConfig, value: unknown) => void;
  getConfiguredCredentialFallback?: (
    config?: DexConfig,
  ) => WebSearchProviderConfiguredCredentialFallback | undefined;
  applySelectionConfig?: (config: DexConfig) => DexConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => DexConfig | Promise<DexConfig>;
