...
function listConfiguredChannelIds(cfg: DexConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: DexConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: DexConfig): ChannelRouteTarget[] {
