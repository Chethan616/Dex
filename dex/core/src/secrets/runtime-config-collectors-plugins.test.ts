...
function makeContext(sourceConfig: DexConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: DexConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: DexConfig): void {
