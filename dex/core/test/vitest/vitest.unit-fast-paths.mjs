...
export const forcedUnitFastTestFiles = [
  ...
  "src/atlas/audit.test.ts",
  "src/atlas/assistant.configured.test.ts",
  "src/atlas/atlas.test.ts",
  "src/atlas/operations.test.ts",
  "src/atlas/overview.test.ts",
  "src/atlas/rescue-policy.test.ts",
  "src/atlas/rescue-message.test.ts",
  "src/atlas/tui-backend.test.ts",
