...
export const forcedUnitFastTestFiles = [
  ...
  "src/conch/audit.test.ts",
  "src/conch/assistant.configured.test.ts",
  "src/conch/conch.test.ts",
  "src/conch/operations.test.ts",
  "src/conch/overview.test.ts",
  "src/conch/rescue-policy.test.ts",
  "src/conch/rescue-message.test.ts",
  "src/conch/tui-backend.test.ts",
