...
const RUN_NODE_SKIP_DTS_BUILD = process.env.DEX_RUN_NODE_SKIP_DTS_BUILD === "1";
...
function buildInputOptions(options: InputOptionsArg): InputOptionsReturn {
  if (process.env.DEX_BUILD_VERBOSE === "1") {
    return undefined;
  }
...
const shouldBuildPrivateQaEntries = process.env.DEX_BUILD_PRIVATE_QA === "1";
...
function buildDockerE2eHarnessEntries(): Record<string, string> {
  return {
    ...
    "auto-reply/reply/commands-atlas": "src/auto-reply/reply/commands-atlas.ts",
    ...
    "atlas/atlas": "src/atlas/atlas.ts",
    "atlas/rescue-message": "src/atlas/rescue-message.ts",
